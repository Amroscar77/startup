...
export default function ProfileScreen() {
  ...
  const avatarUrl = user?.photoURL || `https://ui-avatars.com/api/?name=${encodeURIComponent(userData.displayName || 'U')}&background=006d37&color=fff&size=120`;
          ...
          <div className="bg-surface-container-lowest rounded-2xl border border-outline-variant/10 overflow-hidden shadow-lg">
            {activityLoading ? (
              ...
              <div className="p-6 text-center text-outline">
                ...
                <Link to="/add" className="text-primary font-bold text-sm underline">Post your first price!</Link>
              </div>
            ) : (
              activity.map((item) => (
                <Link
